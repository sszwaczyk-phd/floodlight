...
ovs-vsctl set Interface eth3 ofport_request=4
ovs-vsctl add-port ovs-br0 eth4
ovs-vsctl set Interface eth4 ofport_request=5
ovs-vsctl add-port ovs-br0 eth5
ovs-vsctl set Interface eth5 ofport_request=6
ovs-vsctl add-port ovs-br0 eth6
ovs-vsctl set Interface eth6 ofport_request=7
